...
public partial class AddbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8B012964D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF4FBEC297");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CD7D218F7");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDAC126540");
